...
3) Access the `workbench` named `remote-cluster-sep29-7-notebook`.
...
5) In the terminal, run `cd remote-cluster-sep29-7` to navigate to your sample app's directory.
