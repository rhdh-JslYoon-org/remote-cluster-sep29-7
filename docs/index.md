...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/remote-cluster-sep29-7](https://github.com/rhdh-JslYoon-org/remote-cluster-sep29-7)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/remote-cluster-sep29-7-gitops](https://github.com/rhdh-JslYoon-org/remote-cluster-sep29-7-gitops)

# **Usage**

To access the remote-cluster-sep29-7 application that was deployed using the Software Template, complete the following instructions:
